...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2023/03/16 15:21:32 by mayyildi          #+#    #+#              #
#    Updated: 2023/06/18 19:06:24 by mayyildi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	=	draw/draw3d.c			\
			...
			Parsing/setarg.c Error/errormess.c utils/ft_colorcheck.c utils/ft_strncpy.c \
